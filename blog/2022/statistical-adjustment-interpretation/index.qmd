...
::: a
As @tbl-coverage-probs illustrated, if we present and interpret $L$ or $J$, or $W$ as if they are total effect
...
focus on the feature of the world they case about. If one is interested in a relationship between the
...
wasting words opining about political corruption, electoral systems, or some other nuisance parameter.[^5] One 
might attempt tp object on the grounds that incompetent reviewers often demand otherwise principled 
...
[^5]: In many ways this reccomendation echoes that made by @Huenermund2020
