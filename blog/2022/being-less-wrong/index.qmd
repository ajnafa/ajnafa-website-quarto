...
image: figs/fig-model-averaged-ame-margins.png
toc-location: left
page-layout: full
code-fold: true
---
...
[^2]: It is entirely possible thisd is wrong and doesn't actualy make sense so if someone has a better idea or suggestions for improvements I'd love to hear them.
...
```{r fig-model-averaged-ame-margins, echo = TRUE}
